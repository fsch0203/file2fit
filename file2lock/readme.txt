...
* copy the folder 7zip into a folder of your choice
* make a new entry in the TC button bar (Configuration, Button Bar)
    - at the command line: fill in the path to the 7zip.vbs file
    - for parameters fill in: "%P" "%T" %L
    - for icon file: fill in the path to the 7zip.ico file
    - for tooltip fill in the text: Encrypt or decrypt with 7zip
    - see screenshot
